...
Design.create([
  ...
  {:description => "Design increased ad impressions by 95%.", :source_url => "http://www.empathylab.com/", :tag_list => "ads, website"},
  ...
  {:description => "Design sold $50 million in computers a day.", :source_url => "http://www.frogdesign.com/case-study/dell.com.html", :tag_list => "dell, electronics"}
])
